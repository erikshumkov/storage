    ...
    <div>
      ...
      <div className='filter-section'>
        <div className='filter'>
          <input type='checkbox' id='category-options' className='toggle' />
              ...
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    name='coats'
                    className='checkmark'
                    style={globalState.coats ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.boots ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
                <label className='option-title'>
                  ...
                  />
                  <label
                    style={globalState.accessories ? labelTrue : labelFalse}
                    htmlFor='accessories'
                  >
                    Accessories (8)
                  </label>
                  <span
                    className='checkmark'
                    style={
                      globalState.accessories ? checkboxTrue : checkboxFalse
                    }
                  ></span>
                </label>
              </div>
            ...
            <div className='brandname'>
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.filippa ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.tiger ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.lindeberg ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
              ...
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.glory ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.lacoste ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.lyle ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.oscar ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.peak ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
              <div className='option'>
                <label className='option-title'>
                  ...
                  <span
                    className='checkmark'
                    style={globalState.tretorn ? checkboxTrue : checkboxFalse}
                  ></span>
                </label>
              </div>
            </div>
